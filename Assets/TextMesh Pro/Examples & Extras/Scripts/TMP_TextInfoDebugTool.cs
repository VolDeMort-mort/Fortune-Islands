            ...
            for (int i = 0; i < m_TextInfo.wordCount; i++)
            {
                ...
                for (int j = 0; j < wInfo.characterCount; j++)
                {
                    ...
                    if (isBeginRegion == false && isCharacterVisible)
                    {
                        ...
                        //Log.Info("Start Word Region at [" + currentCharInfo.character + "]");
                        ...
                        if (wInfo.characterCount == 1)
                        {
                            ...
                            //Log.Info("End Word Region at [" + currentCharInfo.character + "]");
                        }
                    }
                ...
                //Log.Info(wInfo.GetWord(m_TextMeshPro.textInfo.characterInfo));
            }
